...
class Register_Notices_Pre_2015_Ct
{
  function registerCustomPost()
  {
    $labels = array(
      'name'               => 'Notícias pré 07/15',
      'singular_name'      => 'Notícia',
      'menu_name'          => 'Notícias pré 07/15',
      'name_admin_bar'     => 'Notícias pré 07/15',
      'add_new'            => 'Adicionar Nova',
      'add_new_item'       => 'Adicionar Nova Notícia',
      'new_item'           => 'Nova Notícia',
      'edit_item'          => 'Editar Notícia',
      'view_item'          => 'Visualizar Notícia',
      'all_items'          => 'Todas as Notícias pré 07/15',
      'search_items'       => 'Pesquisar Notícias pré 07/15',
      'parent_item_colon'  => 'Notícias pré 07/15 Pai:',
    ...
    $args = array(
      ...
      'show_in_menu'        => true,
      'query_var'           => true,
      'rewrite'             => array('slug' => 'ct_noticias_pre_2015'),
    ...
    register_post_type('ct_noticias_pre_2015', $args);
  }
}
